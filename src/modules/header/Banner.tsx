...
function Banner() {
    return (
        <div id="home" className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-background mt-24 sm:mt-24 md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
            <div className="w-full mb-0 sm:mb-0 md:mb-28 lg:mb-28 xl:mb-28 2xl:mb-28 flex flex-wrap items-center justify-evenly">
                <div className="flex-[0.6] text-center sm:text-center md:text-left lg:text-left xl:text-left 2xl:text-left">
                    ...
                    <SparklesText className="text-2xl sm:text-2xl md:text-2xl lg:text-4xl xl:text-4xl 2xl:text-4xl text-[#adfc15] my-4" text={`I'm ${profileData.designation}`} />
                    <p className="text-2xl font-normal text-gray-700 dark:text-gray-200">{profileData.smallSummary}
                    </p>
                </div>
                <div className="mt-16 mb-4" data-aos="zoom-in">
                    ...
                    <div>
                        <div className="relative mt-6">
                            <Dock direction="middle">
                                <DockIcon>
                                    <a href={profileData.social.gmail} target="_blank" rel="noreferrer">
